...
if __name__=='__main__':
    ...
    topology_adjacent_same_edge=float(random.randint(0,150))/100
    topology_adjacent_accessible=float(random.randint(0,150))/100
    topology_adjacent_same_streetname=float(random.randint(0,150))/100
